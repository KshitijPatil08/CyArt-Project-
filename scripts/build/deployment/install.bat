...
if not exist "%SCRIPT_DIR%CyArtAgent.exe" (
    echo ERROR: CyArtAgent.exe not found!
    echo.
    echo Current directory: %SCRIPT_DIR%
    echo Expected file: %SCRIPT_DIR%CyArtAgent.exe
    echo.
    echo Please ensure CyArtAgent.exe is in the same folder as this installer.
    pause
    exit /b 1
)
